...
import com.cabs.Dao.RegisterEmployee;
import com.cabs.Dao.RegisterEmployeeImpl;
...
public class EmployeeRegistration extends HttpServlet{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//ModelEmp emp = new ModelEmp(name,email,"1",dept);
		
		ModelEmp emp = new ModelEmp(name,email,manager,password,dept);
		
		//Send Employee object to database
