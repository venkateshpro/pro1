...
import com.cabs.Dao.Booking;
import com.cabs.Dao.BookingImpl;
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(confirm) {
			out.println("<!DOCTYPE html>\r\n"
					...
					+ "                    <p class=\"text-center\">Your Cab  has been Requested Successfull..</p>\r\n"
					+ "                </div>\r\n"
			...
			out.println("Your  Request Is pendding");
		}
	}
}
